...
router.get('/applied', listingController.getAppliedListings, (req, res) => {
...
router.get('/offers', listingController.getOfferListings, (req, res) => {
  res.status(200).json(res.locals.listings);
});
...
//
router.patch('/update', listingController.updateListings, (req, res) => {
  //   console.log('result', res.locals.updatedListing);
  res.status(200).json(res.locals.updatedListing);
});
router.post('/addJob', listingController.addNewJob, (req, res) => {
  res.status(200).json(res.locals.listings);
});
router.delete('/delete', listingController.deleteListings, (req, res) => {
  res.status(200).json(res.locals.listings);
});
